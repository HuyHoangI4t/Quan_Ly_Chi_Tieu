...
<main class="main-content">
    <div class="container">
        ...
        <div class="section-header" style="margin-bottom: 15px;">
            <h3 style="font-size: 16px; font-weight: 600; color: var(--dark-text);">Số dư các hũ (6 Jars)</h3>
        </div>
        
        <div class="jars-grid">
            <?php 
                // Map màu sắc cho đúng ý nghĩa từng hũ
                $colorMap = [
                    'primary'   => '#EF4444', // NEC - Đỏ
                    'success'   => '#F59E0B', // FFA - Vàng
                    'info'      => '#3B82F6', // LTSS - Xanh
                    'warning'   => '#06B6D4', // EDU - Cyan
                    'danger'    => '#EC4899', // PLAY - Hồng
                    'secondary' => '#10B981'  // GIVE - Xanh lá
                ];
                $colors = array_values($colorMap);
                $i = 0;
            ?>
            <?php foreach ($jars as $code => $jar): 
                $color = $colors[$i % 6];
                $i++;
            ?>
                <div class="jar-mini-card">
                    <div class="jar-border-top" style="background-color: <?php echo $color; ?>;"></div>
                    
                    <div class="jar-name" title="<?php echo $jar['name']; ?>">
                        <?php echo $jar['name']; ?>
                    </div>
                    
                    <div class="jar-balance" style="color: <?php echo $color; ?>;">
                        <?php echo number_format($jar['balance']); ?>đ
                    </div>
                    
                    <span class="jar-percent"><?php echo $jar['percent']; ?>%</span>
                </div>
            <?php endforeach; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="charts-grid">
            ...
            <div class="card chart-card">
                <div class="chart-header">
                    ...
                    <span class="subtitle">Danh mục chi tiêu
                        <?php
